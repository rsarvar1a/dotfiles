...
highlight("NvimTreeEndOfBuffer",                { fg = colours.sel1,  bg = colours.sel1, opt = nil           })
...
highlight("NvimTreeNormal",                     { fg = nil,           bg = colours.sel1, opt = nil           })
...
highlight("NvimTreeVertSplit",                  { fg = colours.bg1,   bg = colours.bg1,  opt = nil           })
...
highlight("VertSplit",                          { fg = colours.sel1,  bg = colours.bg1,  opt = "bold"        })
