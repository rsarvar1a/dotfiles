...
active_text_color="#00000000"
#active_text_color='#ffaacc'
active_bg="#202024"
active_underline="#DC2430"
line_size=4

inactive_text_color="#00000000"
inactive_bg="#121214"
...
add_spaces="true"
resize_increment=15
wm_border_width=6 # setting this might be required for accurate resize position
...
inactive_right=""
separator="%{F#00000000}$separator%{F#00000000}"
